...
import app.trainticket.beans.HistoryBean;
import app.trainticket.beans.TrainException;
import app.trainticket.constant.UserRole;
import app.trainticket.service.BookingService;
import app.trainticket.service.impl.BookingServiceImpl;
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
		...
		try {
			...
			if (details != null && !details.isEmpty()) {
				RequestDispatcher rd = req.getRequestDispatcher("UserViewTrain.html");
				rd.include(req, res);
